 ...
 * approprate data.</p>
 * <p><b>Ext.CustomPagingToolbar</b> is a specialized toolbar that is bound to a {@link Ext.data.Store}
 ...
 * paging criteria.</p>
 * <p>CustomPagingToolbar is typically used as one of the Grid's toolbars:</p>
 * <pre><code>
...
var grid = new Ext.grid.GridPanel({
    ...
    store: myStore,
    bbar: new Ext.CustomPagingToolbar({
        {@link #store}: myStore,       // grid and CustomPagingToolbar using same store
 ...
 * </ul></div>
 * @constructor
 * Create a new CustomPagingToolbar
...
Ext.ux.CustomPagingToolbar = Ext.extend(Ext.Toolbar, {
    /**
    ...
    initComponent : function(){
        ...
        Ext.ux.CustomPagingToolbar.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event change
             * Fires after the active page has been changed.
             * @param {Ext.CustomPagingToolbar} this
             ...
             * @param {Ext.CustomPagingToolbar} this
             * @param {Object} params An object hash of the parameters which the CustomPagingToolbar will send when
    ...
    onDestroy : function(){
        this.bindStore(null);
        Ext.ux.CustomPagingToolbar.superclass.onDestroy.call(this);
    }
});

})();
Ext.reg('custompaging', Ext.ux.CustomPagingToolbar);